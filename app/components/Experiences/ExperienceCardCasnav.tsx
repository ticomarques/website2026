  ...
  return (
    <article className="flex flex-col rounded-lg items-center space-y-3 md:space-y-7 p-4 flex-shrink-0 w-[310px] md:w-[320px] xl:w-[500px] snap-center bg-[#292929] hover:opacity-100 opacity-60 cursor-pointer transition-opacity duration-500 overflow-hidden">
        ...
        <div className="md:px-10">
            <h4 className="text-3xl md:text-3xl font-light text-center">CASNAV</h4>
            <p className="font-bold text-xl mt-1 text-center">Frontend Developer / UX/UI</p>
            ...
            <ul className="list-disc space-y-2 ml-5 text-sm max-h-96 overflow-y-scroll scrollbar-thin scrollbar-track-black scrollbar-thumb-[#F7AB0A]/80">
                <li>Research and design UX/UI for websites and apps.</li>
                <li>Implemented HTML, CSS, and Javascript using DojoJS.</li>
                <li>Developed and maintained the documentation using Wiki (CMS).</li>
                <li>Designed the video tutorials and FAQ for applications using camtasia.</li>
            </ul>
        </div>
    </article>
  )
...
export default ExperienceCardCasnav