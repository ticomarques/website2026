  ...
  return (
    <article className="flex flex-col rounded-lg items-center space-y-3 md:space-y-7 p-4 flex-shrink-0 w-[310px] md:w-[320px] xl:w-[500px] snap-center bg-[#292929] hover:opacity-100 opacity-60 cursor-pointer transition-opacity duration-500 overflow-hidden">
        ...
        <div className="md:px-10">
            <h4 className="text-3xl md:text-3xl font-light text-center">Wooza ventures</h4>
            <p className="font-bold text-xl mt-1 text-center">Frontend Developer / DevOps</p>
            ...
            <ul className="list-disc space-y-2 ml-5 text-sm max-h-96 overflow-y-scroll scrollbar-thin scrollbar-track-black scrollbar-thumb-[#F7AB0A]/80">
                <li>Led the integration between UX/UI designers and Frontend team.</li>
                <li>Developed multiple headless stores using AngularJS 1.5 and Magento.</li>
                <li>Created the AWS plan for backend team, servers, load balancers, subdomains, CDN, and redirects.</li>
                <li>Prepared all Linux servers (EC2) hardening ubuntu with Nginx.</li>
            </ul>
        </div>
    </article>
  )
...
export default ExperienceCardWooza