  ...
  return (
    <article className="flex flex-col rounded-lg items-center space-y-3 md:space-y-7 p-4 flex-shrink-0 w-[310px] md:w-[320px] xl:w-[500px] snap-center bg-[#292929] hover:opacity-100 opacity-60 cursor-pointer transition-opacity duration-500 overflow-hidden">
        ...
        <div className="md:px-10">
            ...
            <p className="font-bold text-xl mt-1 text-center">FullStack Developer / DevOps / AI</p>
            ...
            <div className="flex space-x-2 my-2 md:items-center md:justify-center">        
                ...
                <img className="h-5 w-5 md:h-10 md:w-10 rounded-full" src="https://cdn.sanity.io/images/jj3dt7aq/production/e3fb670c73cf147bc538dc44e01b2ec4f0b693c9-1024x1024.png" alt="TypeScript" />
                <img className="h-5 w-5 md:h-10 md:w-10 rounded-full" src="https://cdn.sanity.io/images/jj3dt7aq/production/948ae5f22d08987cab4466efe03c4613dc1bda3f-112x112.jpg" alt="NextJS" />
            ...
            <ul className="list-disc space-y-2 ml-5 text-sm max-h-96 overflow-y-scroll scrollbar-thin scrollbar-track-black scrollbar-thumb-[#F7AB0A]/80">
                <li>Migrated projects from the Primordia platform (Magento) to the Vtex platform.</li>
                <li>Developed new projects using ReactJS, Redux, Axios, and Vtex REST APIs.</li>
                <li>Developed tests using Jest and Mocha.</li>
                <li>Created and documented design systems using React, and Storybook.</li>
            </ul>
        </div>
    </article>
  )
...
export default ExperienceCardEd3