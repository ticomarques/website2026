...
const ContactSection = () => {
	return (
		<section className="py-20 px-4 bg-gradient-to-b from-gray-900 to-black
							min-h-[100vh] flex items-center justify-center overflow-hidden
		">
			...
			">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center space-y-8">
					...
					<p className="text-gray-400 max-w-2xl mx-auto">
						Ready to bring your project idea to life? I specialize in creating polished, user-friendly projects that deliver exceptional
					...
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<a
							href="mailto:thymarques@gmail.com"
					...
					<div className="flex justify-center gap-6">
						<a
							href="https://github.com/ticomarques/"
							target="_blank"
						...
						<a
							href="https://linkedin.com/in/tiagomarquesleite"
							target="_blank"
							rel="noopener noreferrer"
							className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-full"
						>
